...
contract Ballot {
    // This delcares a new complex type which will
    ...
    // Get address of owner (chairperson)
    function owner() public view returns (address) {
        return chairperson;
    }

    // Get an array of proposal names
    ...
    // Determine if address has voted
    function hasVoted(address voter) public view returns (bool) {
        return voters[voter].voted;
    }

    // Get address voter has delegated vote to
    function delegatedTo(address voter) public view returns (address) {
        return voters[voter].delegate;
    }

    // Check if address has right to vote
    ...
    function vote(uint proposal) public {
        ...
        // this will throw automatically an revert all
        // changes.
